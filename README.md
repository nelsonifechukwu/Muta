...
`make vercel`, or `.github/workflows/vercel.yml` on push) and as this repository's GitHub
Pages project page (`.github/workflows/pages.yml`, manual); see
[docs/report-hosting.md](docs/report-hosting.md). `make pages` renders the same site locally.
...
- [Aristotle](https://www.heyaristotle.com/about)
