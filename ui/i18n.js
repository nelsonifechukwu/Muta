...
(() => {
  ...
  const catalogs = {
    en: {
      ...
      "settings.languageHelp": "Choose the language Muta uses. Auto follows your browser and latest message.",
      "settings.general": "General",
      "settings.parallel": "Generate in multiple chats",
      "settings.parallelHelp": "Start another chat while a reply runs. Replies may be slower.",
