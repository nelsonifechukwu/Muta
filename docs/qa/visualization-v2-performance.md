...
|---|---:|---:|---:|
| Synchronous chat UI source | 74628 B | 106785 B | +32157 B |
| Median Node parse time for synchronous JS | 0.5088 ms | 0.7100 ms | +0.2012 ms |
...
The full gate rendered 200 cases. Peak measured browser JS heap across the responsive matrix was 67164911 bytes.
...
|---|---:|---:|---:|---:|
| svg | 74 | 106.28 ms | 257.90 ms | 315.00 ms |
| canvas | 21 | 163.34 ms | 315.20 ms | 324.40 ms |
| three | 105 | 298.13 ms | 416.60 ms | 688.30 ms |
